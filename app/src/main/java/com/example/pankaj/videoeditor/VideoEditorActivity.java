...
package com.example.pankaj.videoeditor;
...
import com.example.pankaj.videoeditor.components.VideoSeekBarView;
import com.example.pankaj.videoeditor.components.VideoTimelineView;
import com.example.pankaj.videoeditor.messenger.AndroidUtilities;
import com.example.pankaj.videoeditor.ui.LayoutHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compressVideo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(VideoEditorActivity.this);
